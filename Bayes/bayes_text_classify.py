...
def setOfWords2Vec(vocabList, inputSet):
    ...
    for word in inputSet:
        ...
        # returnVec_list.append(returnVec)
    return returnVec
...
def trainNB0(trainMatrix, trainCategory):
    ...
    # 构造单词出现次数列表
    p0Num = ones(numWords) # [0,0,0,.....]
    p1Num = ones(numWords) # [0,0,0,.....]
...
if __name__ == "__main__":
    ...
    # myVocabList = createVocabList(listOPosts)
    # print(myVocabList)
    # print(myVocabList.index('cute'))
    # print(setOfWords2Vec(myVocabList, listOPosts))
    # print(setOfWords2Vec(myVocabList, listOPosts[3]))
    # trainMatrix = setOfWords2Vec(myVocabList, listOPosts)
    # p0Vect, p1Vect, pAbusive = trainNB0(trainMatrix, listClasses)
    # print(p0Vect)
    # print(p1Vect)
    # print(pAbusive)
    testingNB()